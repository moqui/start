...
class StartScreens extends Specification {
    protected final static Logger logger = LoggerFactory.getLogger(StartScreens.class)
    ...
    def setupSpec() {
        ...
        screenTest = ec.screen.makeTest().baseScreenPath("apps/start")
    }
}
...
@Unroll
def "render start (#screenPath, #containsTextList)"() {
    setup:
